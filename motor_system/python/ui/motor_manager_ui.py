...
class MotorManagerUI(QWidget):
    ...
    def save_instance(self):
        try:
            ...
            self.current_instance_id=instance_id; self.load_instances(); self.show_instance_detail(instance_id); QMessageBox.information(self,"Complete",f"Motor Instance {'created' if self.current_instance_id is None else 'updated'}: {instance_id}")
