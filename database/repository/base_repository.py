...
class BaseRepository:
    ...
    def execute(self, query, parameters=None):
        # DatabaseManager.execute expects a sequence for sqlite3. Passing
        # None explicitly causes sqlite3 to raise "parameters are of
        # unsupported type" even for parameterless CREATE/INDEX statements.
