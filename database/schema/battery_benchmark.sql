...
-- Additive schema only. Battery 5A Standalone FW is untouched.
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_benchmark_session
    ON battery_benchmark_result(session_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_instance
